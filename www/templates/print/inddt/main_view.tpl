        ...
        <td width="33%" class="text-top">
            <table class="form" style="width: 100%;">
                <tr height="32">
                    ...
                    <td>{$form.created_at|date_human}{if !empty($form.creator)}, {$form.creator.login}{/if}</td>
                </tr>
                {if !empty($form.modified_at)}
                <tr height="32">
                    <td class="text-right" style="font-weight: bold;">Modified : </td>
                    <td>{$form.modified_at|date_human}{if !empty($form.modifier)}, {$form.modifier.login}{/if}</td>
                </tr>
                {/if}
            </table>
        </td>
