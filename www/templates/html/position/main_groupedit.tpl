...
<table class="list" width="100%">
    <tbody>
        ...
        {else}
            ...
            <td><input type="text" value="{$position.steelposition.thickness|escape:'html'}" id="thickness-{$position.steelposition_id}" name="thickness[{$position.steelposition_id}]" class="max" onkeyup="calc_unitweight({$position.steelposition_id}); calc_weight({$position.steelposition_id}); calc_value({$position.steelposition_id}); calc_total();"></td>
            <td><input type="text" value="{$position.steelposition.width|escape:'html'}" id="width-{$position.steelposition_id}" name="width[{$position.steelposition_id}]" class="max" onkeyup="calc_unitweight({$position.steelposition_id}); calc_weight({$position.steelposition_id}); calc_value({$position.steelposition_id}); calc_total();"></td>
            <td><input type="text" value="{$position.steelposition.length|escape:'html'}" id="length-{$position.steelposition_id}" name="length[{$position.steelposition_id}]" class="max" onkeyup="calc_unitweight({$position.steelposition_id}); calc_weight({$position.steelposition_id}); calc_value({$position.steelposition_id}); calc_total();"></td>
            <td><input type="text" value="{$position.steelposition.unitweight|escape:'html'|string_format:'%.2f'}" id="unitweight-{$position.steelposition_id}" name="unitweight[{$position.steelposition_id}]" class="max" onkeyup="calc_weight({$position.steelposition_id}); calc_value({$position.steelposition_id}); calc_total();"></td>
            <td class="text-center">{$position.steelposition.qtty|escape:'html'|string_format:'%d'}<input type="hidden" value="{$position.steelposition.qtty|escape:'html'|string_format:'%d'}" id="qtty-{$position.steelposition_id}" name="qtty[{$position.steelposition_id}]" class="max" onkeyup="calc_weight({$position.steelposition_id}); calc_value({$position.steelposition_id}); calc_total();"></td>
            <td><input type="text" value="{$position.steelposition.weight|escape:'html'|string_format:'%.2f'}" id="weight-{$position.steelposition_id}" name="weight[{$position.steelposition_id}]" class="max" onkeyup="calc_value({$position.steelposition_id}); calc_total();"></td>
