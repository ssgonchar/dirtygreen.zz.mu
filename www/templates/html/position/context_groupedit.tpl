...
<ul class="nav navbar-nav navbar-right">
	<li>
		<input type="submit" name="btn_cancel" class="btn100" value="Cancel" onclick="return confirm('Am I sure ?');" style="margin-right: 20px;">
    <input type="submit" name="btn_save" class="btn150o" value="Save Selected">
	</li>	
</ul>