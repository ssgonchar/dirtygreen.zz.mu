            ...
            <table class="form" width="100%">
                ...
                <tr style="height: 32px;">
                    ...
                    <td>
                        ...
                        {else}
                        <input id="invoice-biz" class="normal biz-autocomplete" type="text" name="form[biz_title]" {if isset($form.biz)} value="{$form.biz.doc_no_full|escape:'html'}"{/if} placeholder="start typing to select">
