<table class="form" width="75%">
    <tr>
        ...
        <td><input id="search_string" type="text" name="form[keyword]" placeholder="please enter plate id or part of it" class="max"{if isset($keyword)} value="{$keyword|escape:'html'}"{/if}></td>
        <td><input id="search" type="button" name="btn_select" value="Find" class="btn100b"></td>
    </tr>
</table>
<br/>
<br/>
