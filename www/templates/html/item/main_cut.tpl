...
<table id="cut-pieces" class="list" width="100%">
    <tbody>
        ...
        <tr id="piece-{$smarty.foreach.pieces.index}">
            ...
            <td><input type="text" id="width-{$smarty.foreach.pieces.index}" name="pieces[{$smarty.foreach.pieces.index}][width]" value="{$row.width|escape:'html'}" class="max" style="text-align: center;" onkeyup="calc_unitweight({$smarty.foreach.pieces.index});"></td>
            <td><input type="text" id="length-{$smarty.foreach.pieces.index}" name="pieces[{$smarty.foreach.pieces.index}][length]" value="{$row.length|escape:'html'}" class="max" style="text-align: center;" onkeyup="calc_unitweight({$smarty.foreach.pieces.index});"></td>
            <td><input type="text" id="unitweight-{$smarty.foreach.pieces.index}" name="pieces[{$smarty.foreach.pieces.index}][unitweight]" value="{$row.unitweight|escape:'html'}" class="max" style="text-align: center;"></td>
