<table id="t-i" class="list" width="100%">
    <tbody>
        ...
        {else}
            ...
            <td{if isset($multi_weights)} class="wunit"{/if}><input type="text" id="i-unitweight-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][unitweight]" value="{if !empty($row.steelitem.unitweight)}{$row.steelitem.unitweight|number_format:0:true:''|escape:'html'}{/if}" style="width: 100%;"></td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}>
                ...
                {else}
                    <input type="text" id="measured-thickness-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][thickness_measured]" value="{if !empty($row.steelitem.thickness_measured)}{$row.steelitem.thickness_measured|number_format:2:true:''|escape:'html'}{/if}" style="width: 100%;" onkeyup="calc_unitweight({$smarty.foreach.i.index + 1}, '{$row.steelitem.dimension_unit}', '{$row.steelitem.weight_unit}', 'measured');">
                {/if}
            </td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}>
                {if $row.steelitem.parent_id > 0}
