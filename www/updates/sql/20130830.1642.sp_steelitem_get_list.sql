...
-- Дата скрипта: 30/08/2013 14:42:37
...
BEGIN
    ...
    THEN 
        SET var_where = CONCAT(var_where, " AND (si.guid LIKE '%", param_plateid, "%'", IF(LENGTH(CAST(param_plateid AS UNSIGNED)) = LENGTH(param_plateid), CONCAT(" OR id = ", param_plateid), ""), ")"); 
    ELSE
