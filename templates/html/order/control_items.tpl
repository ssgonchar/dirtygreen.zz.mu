<table class="list" width="100%">
    <tbody>
        ...
        <tr id="position-{$position.id}-item-{$item.steelitem.id}">
            ...
            <td onclick="show_position_item_context(event, {$item.steelitem.id}, {$is_revision});" class="text-center pos{$position.id}-unitweight">{if $position.weight_unit =='lb'}{$item.steelitem.unitweight|number_format:0|escape:'html'}{else}{$item.steelitem.unitweight|number_format:2|escape:'html'}{/if}</td>
            <td onclick="show_position_item_context(event, {$item.steelitem.id}, {$is_revision});">
