...
<button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#Help" onClick="return false;" style=" margin-top: -5px">
        Help
      </button>
        ...
        <div class="panel panel-primary filterable">
            ...
            <thead>
                <tr class="top-table">
                    ...
                    <th data-field="for">Order for</th>
                    {* <th>Type</th> *}
                    <th data-field="biz">Biz</th>
                    <th data-field="buyer">Buyer</th>
                    <th data-field="buyer_href">Buyer ref</th>
                    {* <th>Supplier Ref</th> *}
                    <th data-field="delivery_point">Delivery point</th>
                    <th class="text-center" data-field="delivery_date">Delivery date</th>
                    <th class="text-center" data-field="wight">Weight</th>
                    <th class="text-center" data-field="balance">Balance to deliver</th>
                    <th class="text-center" data-field="value">Value</th>
                    <th class="text-center" data-field="price equivalent">Price<br>Equivalent</th>
                    <th class="text-center" data-field="status">Status</th>
                    <th class="text-center" data-field="modified">Modified</th>
            ...
            {foreach from=$list item=row}
                ...
                <td onclick="location.href='/order/{$row.order.id}';" class="text-center">
                    {if $row.order.balance_to_deliver.qtty > 0}
                        {if $row.order.weight_unit|wunit == 'lb'}
                            {$row.order.balance_to_deliver.weight|string_format:'%d'}
                        {else}
                            {$row.order.balance_to_deliver.weight|string_format:'%.2f'}
                        {/if}
                         {*({$row.order.balance_to_deliver.qtty})*}
                    {/if}
                </td>
