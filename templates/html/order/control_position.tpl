<tr id="position-{$row_index}">
    ...
    <td><input type="text" class="order-unitweight" id="unitweight-{$row_index}" name="position[{$row_index}][unitweight]" value="{if isset($row.unitweight)}{if $row.steelposition.weight_unit == 'lb'}{$row.unitweight|number_format:0:true:''|escape:'html'}{else}{$row.unitweight|number_format:2:true:''|escape:'html'}{/if}{/if}" style="width: 100%;" onkeyup="calc_weight({$row_index}); calc_value({$row_index}); calc_total_pos();"></td>
    ...
    <td><input type="text" class="order-weight" id="weight-{$row_index}" name="position[{$row_index}][weight]" value="{if isset($row.weight)}{if $row.steelposition.weight_unit == 'lb'}{$row.weight|number_format:0:true:''|escape:'html'}{else}{$row.weight|number_format:2:true:''|escape:'html'}{/if}{/if}" style="width: 100%;" onkeyup="calc_value({$row_index}); calc_total_pos();"></td>
    {* Weighted Weight *}
