<!-- <div class="navbar navbar-default navbar-fixed-bottom" role="navigation">
	<div class="footer-left" style="width: 50%">{include file="templates/html/email/control_navigation.tpl" page="list"}</div>
...
<ul class="nav navbar-nav footer_panel">
	<li>
		{*include file="templates/html/email/control_navigation.tpl" page="list"*}
	</li>
</ul>
