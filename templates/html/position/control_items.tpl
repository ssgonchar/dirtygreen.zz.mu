<table class="list" width="100%">
    <tbody>
        ...
        <tr id="position-{$position.id}-item-{$item.steelitem.id}">
            ...
            <td onclick="show_position_item_context(event, {$item.steelitem.id}, {$is_revision});" class="text-center pos{$position.id}-unitweight">{if $position.weight_unit == 'lb'}{$item.steelitem.unitweight|escape:'html'|string_format:'%d'}{else}{$item.steelitem.unitweight|escape:'html'|string_format:'%.2f'}{/if}</td>
            <td onclick="show_position_item_context(event, {$item.steelitem.id}, {$is_revision});">
        ...
        <tr>
            <td colspan="16" class="text-left">
                ...
                <div class="text-right" style="float: right;">
                    <a href="/position/{$position.id}/edit" class="edit" style="color: #333; margin-right: 10px;">edit position</a>
                    <a href="/position/{$position.id}/history" class="history" style="color: #333;">position history</a>
                </div>                
            </td>
        </tr>
    </tbody>
