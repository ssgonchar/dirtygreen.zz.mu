...
<table class="list" width="100%">
    <tbody>
        <tr class="top-table">
            <th width="1%"></th>
            <th width="7%" class="text-left"><input type="checkbox" onchange="check_all(this, 'position'); calc_selected(); show_group_actions();" style="margin-left: 2px;">&nbsp;Pos Id</th>
        ...
        <tr id="position-{$row.steelposition_id}">
            ...
            <td {if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if} class="text-left">
                <input type="checkbox" value="{$row.steelposition_id}" class="cb-row-position" onchange="calc_selected(); show_group_actions();">&nbsp;
                <a href="javascript: void(0);" onclick="position_click({$row.steelposition_id}, {$is_revision});">{$row.steelposition_id}</a>
            ...
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if} class="pos">{$row.steelposition.steelgrade.title|escape:'html'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.thickness|escape:'html'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.width|escape:'html'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.length|escape:'html'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});" id="position-unitweight-{$row.steelposition_id}"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.unitweight|escape:'html'|string_format:'%.2f'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}><span id="position-qtty-{$row.steelposition_id}">{$row.steelposition.qtty|escape:'html'|string_format:'%d'}</span>{if isset($row.steelposition.quick) && !empty($row.steelposition.quick.reserved)} (<a href="/positions/reserved">{$row.steelposition.quick.reserved}</a>){/if}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});" id="position-weight-{$row.steelposition_id}"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.weight|escape:'html'|string_format:'%.2f'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});" id="position-price-{$row.steelposition_id}"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.price|escape:'html'|string_format:'%.2f'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});" id="position-value-{$row.steelposition_id}"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.value|escape:'html'|string_format:'%.2f'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if isset($row.steelposition.on_stock) && !empty($row.steelposition.on_stock)} style="background-color: #FEFEFE; font-weight: bold;"{elseif !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{if isset($row.steelposition.deliverytime)}{$row.steelposition.deliverytime.title|escape:'html'}{/if}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.notes|escape:'html'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{$row.steelposition.internal_notes|escape:'html'}</td>
            <td onclick="position_click({$row.steelposition_id}, {$is_revision});"{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>
            ...
            <td{if !empty($row.steelposition.bgcolor)} style="background-color: {$row.steelposition.bgcolor};"{/if}>{if isset($row.steelposition.biz)}<a href="/biz/{$row.steelposition.biz.id}">{$row.steelposition.biz.number_output|escape:'html'}</a>{/if}</td>
            <td>
            {if isset($row.steelposition.attachments)}
                {foreach from=$row.steelposition.attachments item=attachment name="pa"}
                    {if $smarty.foreach.pa.first}
                        <a href="/picture/default/{$attachment.attachment.secret_name}/l/{$attachment.attachment.original_name}" rel="prettyPhoto[steelitem{$row.steelposition_id}]"><img src="/img/icons/picture.png" title="Position Pictures" alt="Position Pictures"></a>
                    {else}
                        <a href="/picture/default/{$attachment.attachment.secret_name}/l/{$attachment.attachment.original_name}" rel="prettyPhoto[steelitem{$row.steelposition_id}]"></a>
                    {/if}
                {/foreach}
            {/if}            
            </td>
        ...
        <tr id="position-items-{$row.steelposition_id}" style="display: none;">
            <td colspan="18" style="padding: 5px 5px 0 30px;" class="text-left">
                {if empty($is_revision)}
                ...
                <table class="list" width="100%">
                    <tbody>
                        <tr class="top-table" style="height: 25px;">
                            <th rowspan="2" width="6%" class="text-left"><input type="checkbox" onchange="check_all(this, 'item-position-{$row.steelposition_id}'); calc_selected(); show_group_actions(); show_selected_items_actions({$row.steelposition_id});" style="margin-left: 2px;">&nbsp;Item Id</th>
                            ...
                            <th rowspan="2" width="20px"><img src="/img/icons/picture-bw.png" title="Position Pictures" alt="Position Pictures"></th>
                        </tr>
                        <tr class="top-table" style="height: 25px;">
                            <th>Number</th>
                            <th>Date</th>
                        ...
                        <tr id="position-{$row.steelposition_id}-item-{$item.steelitem.id}">
                            <td class="text-left">
                                <input type="checkbox" class="cb-row-item-position-{$row.steelposition_id} cb-row-item" value="{$item.steelitem.id}" onchange="show_selected_items_actions({$row.steelposition_id}); calc_selected(); show_group_actions();">&nbsp;
                                <a href="javascript: void(0);" onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 1);">{$item.steelitem.id}</a>
                                {* if empty($is_revision)}
                                <a href="javascript: void(0);" onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 1);">{$item.steelitem.id}</a>
                                {else}
                            ...
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">{$item.steelitem.guid|escape:'html'}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);" class="pos{$row.steelposition_id}-steelgrade">{$item.steelitem.steelgrade.title|escape:'html'}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);" class="text-center pos{$row.steelposition_id}-thickness">{$item.steelitem.thickness|escape:'html'}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);" class="text-center pos{$row.steelposition_id}-width">{$item.steelitem.width|escape:'html'}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);" class="text-center pos{$row.steelposition_id}-length">{$item.steelitem.length|escape:'html'}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);" class="text-center pos{$row.steelposition_id}-unitweight">{$item.steelitem.unitweight|escape:'html'|string_format:'%.2f'}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">{$item.steelitem.purchase_price|escape:'html'|string_format:'%.2f'}</td>
{*                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">{if isset($item.steelitem.supplier)}{$item.steelitem.supplier.title}{/if}</td>    *}
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">{$item.steelitem.in_ddt_number|escape:'html'}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">{if !empty($item.steelitem.in_ddt_date)}{$item.steelitem.in_ddt_date|escape:'html'|date_format:'d/m/Y'}{/if}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">{$item.steelitem.days_on_stock}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">
                                {if $item.steelitem.parent_id > 0}
                                    <div style="margin-bottom: 5px;">
                                        <a href="/item/edit/{$item.steelitem.parent_id}">{$item.steelitem.rel_title}</a>
                                    </div>
                                {/if}
                                {$item.steelitem.internal_notes|escape:'html'}
                            </td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">{if isset($item.steelitem.stockholder)}{$item.steelitem.stockholder.title|escape:'html'}{/if}</td>
                            <td onclick="show_item_block(this, {$item.steelitem.id}, {$row.steelposition_id}, {$is_revision}, 0);">
                            ...
                            {if isset($item.steelitem.attachments)}
                                {foreach from=$item.steelitem.attachments item=attachment name="ia"}
                                    {if $smarty.foreach.ia.first}
                                        <a href="/picture/default/{$attachment.attachment.secret_name}/l/{$attachment.attachment.original_name}" rel="prettyPhoto[steelitem{$item.steelitem.id}]"><img src="/img/icons/picture.png" title="Item Pictures" alt="Item Pictures"></a>
                                    {else}
                                        <a href="/picture/default/{$attachment.attachment.secret_name}/l/{$attachment.attachment.original_name}" rel="prettyPhoto[steelitem{$item.steelitem.id}]"></a>
                                    {/if}
                                {/foreach}
                            {/if}
                            </td>
                ...
                {if empty($is_revision)}                        
                    ...
                    <a href="javascript: void(0);" class="edit" onclick="redirect_selected('item-position-{$row.steelposition_id}', '/position/{$row.steelposition_id}/item/groupedit');">edit selected items</a>
