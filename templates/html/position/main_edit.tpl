...
<table class="list" width="100%">
    <tbody>
        ...
        {else}
            ...
            <td><input type="text" id="unitweight-1" name="position[unitweight]" value="{if !empty($position.steelposition.unitweight)}{if $position.steelposition.weight_unit == 'lb'}{$position.steelposition.unitweight|escape:'html'|string_format:'%d'}{else}{$position.steelposition.unitweight|escape:'html'|string_format:'%.2f'}{/if}{/if}" style="width: 100%;" onkeyup="calc_weight(1); calc_value(1); calc_total();"></td>
            <td><input type="hidden" id="qtty-1" name="position[qtty]" value="{if !empty($position.steelposition.qtty)}{$position.steelposition.qtty|escape:'html'|string_format:'%d'}{else}0{/if}"><span id="lbl-qtty-1">{if !empty($position.steelposition.qtty)}{$position.steelposition.qtty|escape:'html'|string_format:'%d'}{else}0{/if}</span></td>
            <td><input type="text" id="weight-1" name="position[weight]" value="{if !empty($position.steelposition.weight)}{if $position.steelposition.weight_unit == 'lb'}{$position.steelposition.weight|escape:'html'|string_format:'%d'}{else}{$position.steelposition.weight|escape:'html'|string_format:'%.2f'}{/if}{/if}" style="width: 100%;" onkeyup="calc_value(1); calc_total();"></td>
