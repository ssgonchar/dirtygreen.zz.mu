...
<div class="footer-right">
    {if !empty($form.id)}
        ...
        <input type="button" name="btn_dont_save" class="btn100" value="Don't Save" onclick="if(!confirm('Am I sure ?')) return false;location.href='/cmr'">
    {/if}
...
<ul class="nav navbar-nav navbar-right">
	<li>
		{if !empty($form.id)}
			{*<input type="submit" name="btn_dont_save" class="btn100" value="Don't Save" onclick="return confirm('Am I sure ?');">*}
			<input type="button" name="btn_dont_save" class="btn btn-default" style="margin: 7px;" value="Don't Save" onclick="if(!confirm('Am I sure ?')) return false;location.href='/cmr'">
		{/if}
