    ...
    {if !isset($readonly) || !$readonly}
        {if isset($recipient.user.person)} 
            {if isset($recipient.user.person.picture)}
                {picture type="person" size="x" source=$recipient.user.person.picture id="{$recipient.user.id}-user-picture" class="chat-user-{$recipient.chat_status}" onclick="chat_modal_select_user({$recipient.user.id});"}
            {elseif $recipient.user.person.gender == 'f'}
                <img src="/img/layout/anonymf.png" id="{$recipient.user.id}-user-picture" class="chat-user-{$recipient.chat_status}" alt="No Picture" alt="No Picture" onclick="chat_modal_select_user({$recipient.user.id});">
            {else}
                <img src="/img/layout/anonym.png" id="{$recipient.user.id}-user-picture" class="chat-user-{$recipient.chat_status}" alt="No Picture" alt="No Picture" onclick="chat_modal_select_user({$recipient.user.id});">
            {/if}
        {else}
            <img src="/img/layout/anonym.png" id="{$recipient.user.id}-user-picture" class="chat-user-{$recipient.chat_status}" alt="No Picture" alt="No Picture" onclick="chat_modal_select_user({$recipient.user.id});">
        {/if}
