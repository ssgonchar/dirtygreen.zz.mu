                ...
                <div class="col-md-12 col-xs-6">
                    ...
                    <div class="input-group" style="margin-bottom: 10px;">
                        ...
                        <select id="driver-select" name="form[driver]" class="form-control"  style='height: 28px;'>
                            ...
                            {if isset($objects) && $objects.0.object_alias == 'biz'}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="email_text" name="form[description]" style="width: 100%">{if isset($form) && isset($form.description)}{$form.description}{/if}</textarea>
                    </div>
