                ...
                <div id="collapseFilterSettings" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div class='col-xs-4' style="">
                            ...
                            <p>
                                <input type="text" name="form[plate_id]" class="normal"{if isset($plate_id)} value="{$plate_id}"{/if}>
                            </p>
                            </div>
                            <hr>
                            <p class='name'>
                            ...
                            <p>
                                <input type="text" name="form[thickness]" class="normal"{if isset($thickness)} value="{$thickness}"{/if}><span class="size">{if isset($stock)}{$stock.dimension_unit|dunit}{/if}</span>
                            </p>
                        </div>
                        <div class="col-xs-4" style="border-left: 1px solid #ccc;">
                            ...
                            <p id="locations" style='height: 161px;'>
                               {*debug*}
                        {if !empty($locations)}
                            ...
                            {else}
                                ...
                                <label for="cb-location-{$row.stockholder_id}"><input type="checkbox" id="cb-location-{$row.stockholder_id}" name="form[stockholder][{$row.stockholder_id}]" value="{$row.stockholder_id}"{if isset($row.selected)} checked="checked"{/if}>&nbsp;{$row.stockholder.doc_no|escape:'html'}&nbsp;({$row.stockholder.city.title|escape:'html'})&nbsp;&nbsp;</label>
                                </div>
                                {/foreach}
                        ...
                        <label for="cb-type-a"><input type="checkbox" id="cb-type-a" name="form[available]" value="1"{if isset($available) && !empty($available)} checked="checked"{/if}>&nbsp;Only Available Items</label>
                            ...
                            <p>
                                <input type="text" name="form[length]" class="normal"{if isset($length)} value="{$length}"{/if}><span class="size">{if isset($stock)}{$stock.dimension_unit|dunit}{/if}</span>
                            </p>
                        </div>
                        <div class="col-xs-4" style="border-left: 1px solid #ccc;">
                            <p class='name'>
                            ...
                            <p id="stockholders" style='height: 161px;'>
                            ...
                            <p>
                                <u>exact value</u> <input type="text" class="" name="form[weight]" size="8" placeholder="number" {if isset($weight)} value="{$weight}"{/if}>
                                or range 
                            ...
                            <p>
                                ...
                                <input type="text" name="form[width]" class="normal"{if isset($width)} value="{$width}"{/if}><span class="size">{if isset($stock)}{$stock.dimension_unit|dunit}{/if}</span>
                            </p>
                           
                            <input type="submit" name="btn_select" value="Find" class="btn100b" style='float: right;'>
                        </div>
                    </div>
                    <!--    <div class="panel-footer"><input type="submit" name="btn_setfilter" value="Find" class="btn100b" style='margin-left: 87%;'></div> -->
                </div>            
            </div>
        <!--</div>-->
    </div>
