        ...
        <td class="text-top" width="33%">
            <table class="form" width="100%">
                ...
                <tr>
                    ...
                    <td class="text-top"><input type="text" name="form[approve_deadline]" class="datepicker normal" value="{if !empty($form.approve_deadline) && $form.approve_deadline > 0}{$form.approve_deadline|escape:'html'|date_format:'d/m/Y'}{/if}"></td>
                </tr>
            </table>
        </td>
        <td class="text-top">
            <table class="form" width="100%">
                ...
                <tr>
                    ...
                    <td class="text-top"><input type="text" name="form[seek_response]" class="datepicker normal" value="{if !empty($form.seek_response) && $form.seek_response > 0}{$form.seek_response|escape:'html'|date_format:'d/m/Y'}{/if}"></td>
                </tr>
            </table>        
        </td>
        <td class="text-top" width="33%">
