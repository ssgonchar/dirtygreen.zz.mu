        ...
        <td class="text-top">
            ...
            <table class="form" style="background: #f5f5f5;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="form[weighed_weight]" value="{if isset($form.weighed_weight) && $form.weighed_weight > 0}{$form.weighed_weight|string_format:'%.2f'}{/if}" class="narrow" maxlength="20" /></td>
                </tr>                
                <tr style="height: 32px;">
...
<table class="list" style="width: 100%">
    <tr class="top-table" style="height: 25px;">
        ...
        <th rowspan="2">Weight,<br />{$form.weight_unit}</th>
