<table id="t-i" class="list" width="100%">
    <tbody>
        ...
        {else}
            ...
            <td{if isset($multi_dimensions)} class="dunit"{/if}><input class="i-thickness-input" type="text" id="i-thickness-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][thickness]" value="{if !empty($row.steelitem.thickness)}{$row.steelitem.thickness|number_format:2:true:''|escape:'html'}{/if}" style="width: 100%;" onkeyup="calc_unitweight({$smarty.foreach.i.index + 1}, '{$row.steelitem.dimension_unit}', '{$row.steelitem.weight_unit}', 'i');"></td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}><input class="i-width-input" type="text" id="i-width-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][width]" value="{if !empty($row.steelitem.width)}{$row.steelitem.width|escape:'html'}{/if}" style="width: 100%;" onkeyup="calc_unitweight({$smarty.foreach.i.index + 1}, '{$row.steelitem.dimension_unit}', '{$row.steelitem.weight_unit}', 'i');"></td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}><input class="i-length-input" type="text" id="i-length-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][length]" value="{if !empty($row.steelitem.length)}{$row.steelitem.length|escape:'html'}{/if}" style="width: 100%;" onkeyup="calc_unitweight({$smarty.foreach.i.index + 1}, '{$row.steelitem.dimension_unit}', '{$row.steelitem.weight_unit}', 'i');"></td>
            <td{if isset($multi_weights)} class="wunit"{/if}><input class="i-unitweight-input" type="text" id="i-unitweight-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][unitweight]" value="{if !empty($row.steelitem.unitweight)}{if $row.steelitem.weight_unit == 'lb'}{$row.steelitem.unitweight|escape:'html'|string_format:'%d'}{else}{$row.steelitem.unitweight|escape:'html'|string_format:'%.2f'}{/if}{/if}" style="width: 100%;"></td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}>
                ...
                {else}
                    <input type="text" class="measured-thickness-input" id="measured-thickness-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][thickness_measured]" value="{if !empty($row.steelitem.thickness_measured)}{$row.steelitem.thickness_measured|number_format:2:true:''|escape:'html'}{/if}" style="width: 100%;" onkeyup="calc_unitweight({$smarty.foreach.i.index + 1}, '{$row.steelitem.dimension_unit}', '{$row.steelitem.weight_unit}', 'measured');">
                {/if}
            </td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}>
                {if $row.steelitem.parent_id > 0}
                ...
                {else}
                    <input type="text" class="measured-width-input" id="measured-width-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][width_measured]" value="{if !empty($row.steelitem.width_measured)}{$row.steelitem.width_measured|escape:'html'}{/if}" style="width: 100%;" onkeyup="calc_unitweight({$smarty.foreach.i.index + 1}, '{$row.steelitem.dimension_unit}', '{$row.steelitem.weight_unit}', 'measured');">
                {/if}            
            </td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}>
                {if $row.steelitem.parent_id > 0}
                ...
                {else}
                    <input type="text"class="measured-length-input" id="measured-length-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][length_measured]" value="{if !empty($row.steelitem.length_measured)}{$row.steelitem.length_measured|escape:'html'}{/if}" style="width: 100%;" onkeyup="calc_unitweight({$smarty.foreach.i.index + 1}, '{$row.steelitem.dimension_unit}', '{$row.steelitem.weight_unit}', 'measured');">
                {/if}
            </td>
            <td{if isset($multi_weights)} class="wunit"{/if}>
                ...
                {else}
                    <input type="text" class="measured-unitweight-input" id="measured-unitweight-{$smarty.foreach.i.index + 1}" name="item[{$smarty.foreach.i.index + 1}][unitweight_measured]" value="{if $row.steelitem.unitweight_measured > 0}{if $row.steelitem.weight_unit == 'lb'}{$row.steelitem.unitweight_measured|escape:'html'|string_format:'%d'}{else}{$row.steelitem.unitweight_measured|escape:'html'|string_format:'%.2f'}{/if}{/if}" style="width: 100%;">
                {/if}
            </td>
            <td{if isset($multi_dimensions)} class="dunit"{/if}>
                {if $row.steelitem.parent_id > 0}
...
-->
            <td>
                {if $row.steelitem.parent_id > 0}
                    ...
                    {elseif $row.steelitem.parent.properties.condition == 'n'}Furnace Normalized
                ...
                {else}
                    ...
                    {elseif $row.steelitem.properties.condition == 'n'}Furnace Normalized
...
-->
            <td>
                <select name="item_property[{$smarty.foreach.i.index + 1}][condition]" style="width: 100%;">
                    ...
                    <option value="n"{if $row.steelitem.properties.condition == 'n'} selected="selected"{/if}>Furnace Normalized</option>
