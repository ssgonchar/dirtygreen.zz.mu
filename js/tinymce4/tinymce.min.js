...
! function(e, t) {
    ...
    var s = {},
        ...
        B = "tinymce/dom/Selection",
        L = "tinymce/fmt/Preview",
        D = "tinymce/Formatter",
    ...
    r(l, [], function() {
        ...
        return function(i, o) {
            ...
            i = i || {}, s.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var s = this,
                    l, c = 0,
                    d, u, f = [],
                    p, m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O, I = 0,
                    F = t.decode,
        ...
        return function(r, i) {
            ...
            function p(e) {
                ...
                for (r in N)
                    if (o = N[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], Math.abs(a - c) < 8 && Math.abs(s - d) < 8) {
                        E = o;
                        break
                    }
            ...
            var C = i.dom,
                x = t.each,
                w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O = i.getDoc(),
                I = document,
                F = n.ie && n.ie < 11;
            N = {
                n: [.5, 0, 0, -1],
        ...
        return function(i) {
            ...
            function m(t, n, r) {
                ...
                if (h)
                    if (r) r.nodeType ? (y = z.createRng(), y.setStartBefore(r), y.setEndAfter(r), u(A(y, f), null, !0)) : u(r, null, !0);
            ...
            function A(t, n, r) {
                ...
                function d(t, n, o) {
                    ...
                    for (s = new e(t, z.getParent(t, q) || i.getBody()); l = s[o ? "prev" : "next"]();)
                        if (3 === l.nodeType) {
                            if (d = l, c = a(l), -1 !== c) return {
                                container: l,
                                offset: c
                            }
                        } else if (q(l)) break;
                    return d ? (n = o ? 0 : d.length, {
                        container: d,
                        offset: n
                    }) : void 0
                }
            ...
            function B(e, t, n, r) {
                ...
                if ("all" != e.remove)
                    for (nt(e.styles, function(e, i) {
                        ...
                        if (0 !== o[i].nodeName.indexOf("_")) return G;
            ...
            function H(e, t) {
                function n(e, t) {
                    ...
                    function r(e, t) {
                        ...
                        for (r in t)
                            if (t.hasOwnProperty(r)) return G;
                        return X
                    }
            ...
            function O(t, n, r) {
                ...
                function p() {
                    ...
                    if (u)
                        if (l) s = W.getBookmark(), e.collapse(!0), e = A(e, d(n), !0), e = V.split(e), h(n, r, e), W.moveToBookmark(s);
                        else {
            ...
            var F = {},
                ...
                q = z.isBlock,
                j = i.settings.forced_root_block,
                $ = z.nodeIndex,
                K = "\ufeff",
                Y = /^(src|href|style)$/,
                G = !1,
            ...
            function o(o) {
                ...
                if (k = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(k), R = k.startContainer, A = k.startOffset, F = (l.force_p_newlines ? "p" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", L = a.doc.documentMode, D = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = N(R)) {
                        ...
                        F && B === i.getBody() || (F = F || "P", y() ? (M = /^(H[1-6]|PRE|FIGURE)$/.test(O) && "HGROUP" != I ? v(F) : v(), l.end_container_on_empty_block && f(P) && a.isEmpty(B) ? M = a.split(P, B) : a.insertAfter(M, B), h(M)) : y(!0) ? (M = B.parentNode.insertBefore(v(), B), p(M), h(B)) : (S = k.cloneRange(), S.setEndAfter(B), H = S.extractContents(), _(H), M = H.firstChild, a.insertAfter(H, B), m(M), E(B), h(M)), a.setAttrib(M, "id", ""), i.fire("NewBlock", {
                            newBlock: M
                        }), c.add())
                    }
                }
        ...
        function n(e) {
            ...
            function f(n) {
                ...
                f.on("init", function() {
                    ...
                    f.selection.lastFocusBookmark && (f.selection.setRng(c(f, f.selection.lastFocusBookmark)), f.selection.lastFocusBookmark = null), t != f && (t && t.fire("blur", {
                        focusedEditor: f
                    }), e.activeEditor = f, e.focusedEditor = f, f.fire("focus", {
                        blurredEditor: t
                    ...
                    var t = this,
                        ...
                        if (e) {
                            ...
                            return t.activeEditor == i && (t.activeEditor = r[0]), o && t.fire("RemoveEditor", {
                                editor: i
                            }), r.length || l.unbind(window, "beforeunload", p), i.remove(), i
                        }
        ...
        return e.extend({
            recalc: function(e) {
                var t, n, r, i, o, a, s, l, c, d, u, f, p, m, h, g, v = [],
                    y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O, I, F, z = Math.max,
                    W = Math.min;
